...
public class JournalHacksUtil {
	public static void populateTokens(
		...
		String xmlRequest = portletRequestModel.toXML();
	...
	public static List<TemplateNode> getTemplateNodes(
		...
		for (Element dynamicElementElement : dynamicElementElements) {
			...
			TemplateNode templateNode = new TemplateNode(
					themeDisplay, name, stripCDATA(data), type, new HashMap<String, String>());
	...
	private static void _populateCustomTokens(Map<String, Object> tokens) {
		if (_customTokens == null) {
			...
			for (String customToken :
					PropsUtil.getArray(JournalServiceConfigurationKeys.JOURNAL_ARTICLE_CUSTOM_TOKENS)) {

				String value = PropsUtil.get(
						JournalServiceConfigurationKeys.JOURNAL_ARTICLE_CUSTOM_TOKEN_VALUE,
